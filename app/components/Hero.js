    ...
    <AuroraBackground className="bg-black">
      <div className={`${font.className} min-h-screen relative w-[100%]`}>
        ...
        <div className='flex flex-col gap-4'>
          <p className='text-5xl font-bold'><span className='text-fuchsia-400'>Hello,</span> I'm Intikhab Farooqi</p>
            <p>Full Stack Engineer. Blockchain Developer. AI Engineer</p>
            <p className='max-w-xl'>I'm a full stack engineer with over 10 years of experience in the industry with a passion for building web and mobile applications. I'm also a blockchain developer and an AI engineer.</p>
